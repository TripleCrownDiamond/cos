    ...
    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
        <div class="card card-dark">
            <div class="card-header">
                <h4>Recharger le compte du partenaire</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    {{-- <div class="col-12" >
                        <h6 class="text-danger" >Le montant affiché dans le champ ci dessous est le solde actuel du partenaire. Remplacer ce montant par celui que vous voulez ajouter à son solde.</h6>
                    </div> --}}
                </div><br>
                ...
                <form method="POST" wire:submit.prevent = "updateBalance">
                    <div class="row">
                        <div class="form-group col-12">
                            <label for="first_name">Montant à recharger en Fcfa</label>
                            <input placeholder="" type="text" class="form-control @error('editUserBalance.newbalance') is-invalid @enderror" wire:model.lazy ="editUserBalance.newbalance" autofocus="" name="amount" >
