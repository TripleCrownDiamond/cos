    ...
    <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown {{ setMenuClass ('dashboard', 'active') }}">
              <a href=" {{ route('dashboard') }} " class="nav-link"><i data-feather="monitor"></i><span>Vue globale</span></a>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" wire:click.prevent = "goToAddPartner()" ><i class="
                  fas fa-user-plus"></i>Ajouter</a></li>
                <li><a class="nav-link" href="widget-data.html"><i class="
                  fas fa-users-cog"></i>Gérer</a></li>
                <li><a class="nav-link" href="widget-data.html"><i class="
                  fas fa-user-lock"></i>Permissions</a></li>
              </ul>
            </li>
            @endcan
            
            <li class="dropdown {{ setMenuClass ('addpartner', 'active') }}">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="users"></i><span>Partenaires</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('addpartner') }}"><i class="
                  fas fa-user-plus"></i>Ajouter</a></li>
                <li><a class="nav-link" href="{{ route('partners') }}"><i class="
                  fas fa-users-cog"></i>Gérer</a></li>
              </ul>
            </li> --}}

            @can('admin')
            <li class="dropdown {{ setMenuClass ('users.partners', 'active') }}">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="users"></i><span>Utilisateurs</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" ><i class="
                  fas fa-user-plus"></i>Managers</a></li>
                <li><a class="nav-link" href="{{ route('auth.users.partners.index') }}"><i class="
                  fas fa-user-plus"></i>Partenaires</a></li>
              </ul>
            </li>
            <li class=""></li>
              <li class="dropdown {{ setMenuClass ('formulas', 'active') }}">
