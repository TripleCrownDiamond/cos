                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <small><a class="btn btn-success" href="https://wa.me/{{ $user->whatsapp }}" target="blank" > <i class="fab fa-whatsapp"></i> Contacter </a></small>
                            @endif
                        </td>
                        <td><small><span class="tag tag-success">{{ $user->created_at->diffForHumans() }}</span></small></td>
                        <td>
                            <button class="btn btn-dark btn-circle btn-sm" wire:click="goToEditUser({{$user->id}})"> <i class="far fa-edit"></i> </button>
